        ...
        <aside class="bg-white w-64 p-6 shadow-md">
          <ul class="space-y-4">
            ...
            <div class="flex-1  mx-auto p-8 bg-white shadow-md rounded-lg">
              <h2 class="text-2xl font-bold mb-4">Edit Students</h2>
              <form @submit.prevent="updateProfile">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div class="flex flex-col sm:col-span-2">
                    <label for="profileImage" class="mb-2 font-semibold">Upload Student Photo</label>
                    <input id="profileImage" type="file" class="p-2 border rounded">
                  </div>
                </div>
          ...
          try {
            ...
            const { data: profileData, error: profileError } = await supabase
              ...
              .update({
                ...
                profile_image: form.value.profileImage,
              })
